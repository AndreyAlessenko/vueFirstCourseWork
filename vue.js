...
const App = {
  data() {
    return {
      ...
      isBackButton: true // Флаг, указывающий, скрыта ли кнопка "Назад"
    }
  },

  //Методы
  methods: {
    // Метод перехода на предыдущий шаг
    prev() {
      if (this.activeIndex > 0) {
        this.activeIndex--
      }
    },
    //Метод, сбрасывающий текущий шаг
    reset() {
      this.activeIndex = 0
    },
    ...
    // Метод выбора шага в зависимости от того, какую кнопку мы нажали
    setActive(idx) {
      this.activeIndex = idx
    },
    // Метод, скрывающий кнопку назад 
    finish() {
      this.isBackButton = false
    },
    // Метод, срабатывающий при начале цикла заново
    newCycle() {
      this.reset(),
  ...
  computed: {
    ...
    //Проверяем, находимся ли мы на последнем шаге
    lastStep() {
      if (this.activeIndex == 4) {
        return true
      } else {
    ...
    //Проверяем, скрыта ли кнопка "Назад"
    hideBackButton() {
